...
class MainActivity: AppCompatActivity() {
    ...
    inner class ProjectMGLView(context: Context, assetPath: String) : GLSurfaceView(context) {
        private var mRenderer: RendererWrapper

        init {
            this.setEGLContextClientVersion(2)
            this.mRenderer = RendererWrapper(assetPath).also {
                this.setRenderer(it)
            }
        }
    ...
    private lateinit var glSurfaceView: ProjectMGLView
